function spell_dialog_open(spell) 
{
    var el = document.getElementById('spell_dialog');
    el.open = true;
    //el.empty();
    el.innerHTML = '<iframe style="width:80%; height:100%" src="https://www.dnd-spells.com/spell/' + spell + '"></iframe>';
    //a href="https://www.dnd-spells.com/spell/' + link + '">'
    // http://ephe.github.io/grimoire/     https://donjon.bin.sh/5e/spells/     https://www.dnd-spells.com/spell/
...
function resetAbil() {
    ...
    document.getElementById("a2").selectedIndex = "7";
    document.getElementById("a3").selectedIndex = "7";
    document.getElementById("a4").selectedIndex = "7";
    document.getElementById("a5").selectedIndex = "7";
    document.getElementById("a6").selectedIndex = "7";
    addAbils(false);
}

function setStandardArray() {
    document.getElementById("a1").selectedIndex = "14";
    document.getElementById("a2").selectedIndex = "14";
    document.getElementById("a3").selectedIndex = "13";
    document.getElementById("a4").selectedIndex = "12";
    document.getElementById("a5").selectedIndex = "9";
    document.getElementById("a6").selectedIndex = "7";
    addAbils(false);
}
...
function run() {
    ...
    var speed = 0;
    var size = "Medium";
    var factions = ["Harpers", "Order of the Gauntlet", "Emerald Enclave", "Lords' Alliance", "Zhentarim", "Chroma Conclave", "The Clasp"];
    var myFaction = -1;
    ...
    var patronSpells4 = [];
    var patronSpells5 = [];
    var pa1 = ["Bless", "Command", "Compelled Duel", "Cure Wounds", "Detect Evil and Good", "Detect Magic Ritual", "Detect Poison and Disease Ritual", "Divine Favor", "Heroism", "Protection from Evil and Good", "Purify Food and Drink", "Searing Smite", "Shield of Faith", "Thunderous Smite", "Wrathful Smite"];
    var pa2 = ["Aid", "Branding Smite", "Find Steed", "Lesser Restoration", "Locate Object", "Magic Weapon", "Protection from Poison", "Zone of Truth"];
    
    var pa3 = ["Aura of Vitality", "Blinding Smite", "Create Food and Water", "Crusader's Mantle", "Daylight", "Dispel Magic", "Elemental Weapon", "Magic Circle", "Remove Curse", "Revivify"];
    var pa4 = ["Aura of Life", "Aura of Purity", "Banishment", "Death Ward", "Locate Creature", "Staggering Smite"];
    var pa5 = ["Banishing Smite", "Banishing Smite", "Circle of Power", "Destructive Wave", "Dispel Evil and Good", "Geas", "Raise Dead", "Raise Dead", "Raise Dead"];
    
    var ra1 = ["Absorb Elements", "Beast Bond", "Alarm Ritual", "Animal Friendship", "Cure Wounds", "Detect Magic Ritual", "Detect Poison and Disease Ritual", "Ensnaring Strike", "Fog Cloud", "Goodberry", "Hail of Thorns", "Hunter's Mark", "Jump", "Longstrider", "Speak with Animals"];
    var ra2 = ["Animal Messenger Ritual", "Barkskin", "Beast Sense Ritual", "Cordon of Arrows", "Darkvision", "Find Traps", "Lesser Restoration", "Locate Animals or Plants Ritual", "Locate Object", "Pass without Trace", "Protection from Poison", "Silence Ritual", "Spike Growth"];
    
    var ra3 = ["Flame Arrows", "Conjure Animals", "Conjure Barrage", "Daylight", "Lightning Arrow", "Nondetection", "Plant Growth", "Protection from Energy", "Speak with Plants", "Water Breathing Ritual", "Water Walk Ritual", "Wind Wall"];
    var ra4 = ["Conjure Woodland Beings", "Freedom of Movement", "Freedom of Movement", "Grasping Vine", "Locate Creature", "Stoneskin"];
    var ra5 = ["Commune with Nature Ritual", "Conjure Volley", "Conjure Volley", "Swift Quiver", "Swift Quiver", "Swift Quiver", "Tree Stride"];
    
    
    var clCantrip = ["Guidance", "Light", "Mending", "Resistance", "Sacred Flame", "Spare the Dying", "Thaumaturgy"];
    var cl1 = ["Bane", "Bless", "Command", "Create or Destroy Water", "Cure Wounds", "Detect Evil and Good", "Detect Magic Ritual", "Detect Poison and Disease Ritual", "Guiding Bolt", "Healing Word", "Inflict Wounds", "Protection from Evil and Good", "Purify Food and Drink", "Sanctuary", "Shield of Faith"];
    var cl2 = ["Aid", "Augury Ritual", "Blindness/Deafness", "Calm Emotions", "Continual Flame", "Enhance Ability", "Find Traps", "Gentle Repose Ritual", "Hold Person", "Lesser Restoration", "Locate Object", "Prayer of Healing", "Protection from Poison", "Silence Ritual", "Spiritual Weapon", "Warding Bond", "Zone of Truth"];
    var cl3 = ["Animate Dead", "Beacon of Hope", "Bestow Curse", "Clairvoyance", "Create Food and Water", "Daylight", "Dispel Magic", "Feign Death Ritual", "Glyph of Warding", "Magic Circle", "Mass Healing Word", "Meld into Stone Ritual", "Protection from Energy", "Remove Curse", "Revivify", "Sending", "Speak with Dead", "Spirit Guardians", "Tongues", "Water Walk Ritual"];
    var cl4 = ["Banishment", "Control Water", "Death Ward", "Divination Ritual", "Freedom of Movement", "Guardian of Faith", "Locate Creature", "Stone Shape"];
    var cl5 = ["Commune Ritual", "Contagion", "Dispel Evil and Good", "Flame Strike", "Geas", "Greater Restoration", "Hallow", "Insect Plague", "Legend Lore", "Mass Cure Wounds", "Planar Binding", "Raise Dead", "Scrying"];
    var cl6 = ["Blade Barrier", "Create Undead", "Find the Path", "Forbiddance Ritual", "Harm", "Heal", "Heroes' Feast", "Planar Ally", "True Seeing", "Word of Recall"];
    var cl7 = ["Conjure Celestial", "Divine Word", "Etherealness", "Fire Storm", "Plane Shift", "Regenerate", "Resurrection", "Symbol"];
    var cl8 = ["Antimagic Field", "Control Weather", "Earthquake", "Holy Aura"];
    var cl9 = ["Astral Projection", "Gate", "Mass Heal", "True Resurrection"];
    ...
    var ba1 = ["Animal Friendship", "Bane", "Charm Person", "Comprehend Languages Ritual", "Cure Wounds", "Detect Magic Ritual", "Disguise Self", "Dissonant Whispers", "Earth Tremor", "Faerie Fire", "Feather Fall", "Healing Word", "Heroism", "Identify Ritual", "Illusory Script Ritual", "Longstrider", "Silent Image", "Sleep", "Speak with Animals", "Tasha's Hideous Laughter", "Thunderwave", "Unseen Servant Ritual"];
    var ba2 = ["Animal Messenger Ritual", "Blindness/Deafness", "Calm Emotions", "Cloud of Daggers", "Crown of Madness", "Detect Thoughts", "Enhance Ability", "Enthrall", "Heat Metal", "Hold Person", "Invisibility", "Knock", "Lesser Restoration", "Locate Animals or Plants Ritual", "Locate Object", "Magic Mouth Ritual", "Phantasmal Force", "Pyrotechnics", "See Invisibility", "Shatter", "Silence Ritual", "Suggestion", "Warding Wind", "Zone of Truth"];
    var ba3 = ["Bestow Curse", "Clairvoyance", "Dispel Magic", "Fear", "Feign Death Ritual", "Glyph of Warding", "Hypnotic Pattern", "Leomund’s Tiny Hut Ritual", "Major Image", "Nondetection", "Plant Growth", "Sending", "Speak with Dead", "Speak with Plants", "Stinking Cloud", "Tongues"];
    ...
    var ba6 = ["Eyebite", "Find the Path", "Guards and Wards", "Mass Suggestion", "Otto's Irresistible Dance", "Programmed IlIusion", "True Seeing"];
    var ba7 = ["Etherealness", "Forcecage", "Mirage Arcane", "Mordenkainen's Magnificent Mansion", "Mordenkainen's Sword", "Project Image", "Regenerate", "Resurrection", "Symbol", "Teleport"];
    var ba8 = ["Dominate Monster", "Feeblemind", "Glibness", "Mind Blank", "Power Word Stun"];
    var ba9 = ["Foresight", "Power Word Heal", "Power Word Kill", "True Polymorph"];
    ...
    var dr1 = ["Absorb Elements", "Beast Bond", "Ice Knife", "Earth Tremor", "Animal Friendship", "Charm Person", "Create or Destroy Water", "Cure Wounds", "Detect Magic Ritual", "Detect Poison and Disease Ritual", "Entangle", "Faerie Fire", "Fog Cloud", "Goodberry", "Healing Word", "Jump", "Longstrider", "Purify Food and Drink", "Speak with Animals", "Thunderwave"];
    var dr2 = ["Dust Devil", "Earthbind", "Skywrite Ritual", "Warding Wind", "Animal Messenger Ritual", "Barkskin", "Beast Sense Ritual", "Darkvision", "Enhance Ability", "Find Traps", "Flame Blade", "Flaming Sphere", "Gust of Wind", "Heat Metal", "Hold Person", "Lesser Restoration", "Locate Object", "Moonbeam", "Pass without Trace", "Protection from Poison", "Spike Growth"];
    var dr3 = ["Erupting Earth", "Flame Arrows", "Tidal Wave", "Wall of Water", "Call Lightning", "Conjure Animals", "Daylight", "Dispel Magic", "Feign Death Ritual", "Meld into Stone Ritual", "Plant Growth", "Protection from Energy", "Sleet Storm", "Speak with Plants", "Water Breathing Ritual", "Water Walk Ritual", "Wind Wall"];
    ...
    var dr5 = ["Control Winds", "Maelstrom", "Transmute Rock", "Antilife Shell", "Awaken", "Commune with Nature Ritual", "Conjure Elemental", "Contagion", "Geas", "Greater Restoration", "Insect Plague", "Mass Cure Wounds", "Planar Binding", "Reincarnate", "Scrying", "Tree Stride", "Wall of Stone"];
    var dr6 = ["Conjure Fey", "Find the Path", "Heal", "Heroes' Feast", "Move Earth", "Sunbeam", "Transport via Plants", "Wall ofThorns", "Wind Walk"];
    var dr7 = ["Fire Storm", "Mirage Arcane", "Plane Shift", "Regenerate", "Reverse Gravity"];
    var dr8 = ["Animal Shapes", "Antipathy/Sympathy", "Control Weather", "Earthquake", "Feeblemind", "Sunburst", "Tsunami"];
    var dr9 = ["Foresight", "Shapechange", "Shapechange", "Storm ofVengeance", "True Resurrection", "True Resurrection"];
    ...
    var so1 = ["Catapult", "Ice Knife", "Earth Tremor", "Burning Hands", "Burning Hands", "Charm Person", "Chromatic Orb", "Color Spray", "Comprehend Languages Ritual", "Detect Magic Ritual", "Disguise Self", "Expeditious Retreat", "False Life", "Feather Fall", "Fog Cloud", "Jump", "Magic Missile", "Magic Missile", "Mage Armor", "Ray of Sickness", "Shield", "Silent Image", "Sleep", "Thunderwave", "Witch Bolt"];
    ...
    var so3 = ["Erupting Earth", "Flame Arrows", "Melf's Minute Meteors", "Wall of Water", "Blink", "Clairvoyance", "Counterspell", "Daylight", "Dispel Magic", "Fear", "Fireball", "Fly", "Gaseous Form", "Haste", "Hypnotic Pattern", "Lightning Bolt", "Major Image", "Protection from Energy", "Sleet Storm", "Slow", "Stinking Cloud", "Tongues", "Water Breathing Ritual", "Water Walk Ritual"];
    ...
    var so6 = ["Arcane Gate", "Chain Lightning", "Circle of Death", "Disintegrate", "Eyebite", "Globe of Invulnerability", "Mass Suggestion", "Move Earth", "Sunbeam", "True Seeing"];
    var so7 = ["Delayed Blast Fireball", "Etherealness", "Finger of Death", "Fire Storm", "Plane Shift", "Prismatic Spray", "Reverse Gravity", "Teleport"];
    var so8 = ["Dominate Monster", "Earthquake", "Incendiary Cloud", "Power Word Stun", "Sunburst"];
    var so9 = ["Gate", "Meteor Swarm", "Meteor Swarm", "Power Word Kill", "Power Word Kill", "Time Stop", "Time Stop", "Time Stop", "Wish", "Wish", "Wish", "Wish", "Wish"];
    ...
    var wa1 = ["Armor of Agathys", "Arms of Hadar", "Charm Person", "Comprehend Languages Ritual", "Expeditious Retreat", "Hellish Rebuke", "Hex", "Illusory Script Ritual", "Protection from Good and Evil", "Unseen Servant Ritual", "Witch Bolt"];
    ...
    var wa5 = ["Contact Other Plane Ritual", "Dream", "Hold Monster", "Scrying"];
    var wa6 = ["Arcane Gate", "Circle of Death", "Conjure Fey", "Create Undead", "Eyebite", "Flesh to Stone", "Mass Suggestion", "True Seeing"];
    var wa7 = ["Etherealness", "Finger of Death", "Forcecage", "Plane Shift"];
    var wa8 = ["Demiplane", "Dominate Monster", "Feeblemind", "Glibness", "Power Word Stun"];
    var wa9 = ["Astral Projection", "Foresight", "Imprisonment", "Power Word Kill", "True Polymorph"];
    
    
    var tomeRituals = ["Illusory Script Ritual", "Identify Ritual", "Identify Ritual", "Identify Ritual", "Find Familiar Ritual", "Detect Disease and Poison", "Detect Magic Ritual", "Detect Magic Ritual", "Detect Magic Ritual", "Comprehend Languages Ritual", "Unseen Servant Ritual", "Tenser's Floating Disk Ritual", "Speak with Animals", "Speak with Animals", "Purify Food and Drink", "Alarm Ritual", "Alarm Ritual"];
    ...
    var wi1 = ["Absorb Elements", "Catapult", "Ice Knife", "Earth Tremor", "Alarm Ritual", "Burning Hands", "Charm Person", "Chromatic Orb", "Color Spray", "Comprehend Languages Ritual", "Detect Magic Ritual", "Disguise Self", "Expeditious Retreat", "False Life", "Feather Fall", "Find Familiar Ritual", "Find Familiar Ritual", "Fog Cloud", "Grease", "Identify Ritual", "Illusory Script Ritual", "Jump", "Longstrider", "Mage Armor", "Magic Missile", "Protection from Good and Evil", "Ray of Sickness", "Shield", "Silent Image", "Sleep", "Tasha's Hideous Laughter", "Tenser's Floating Disk Ritual", "Thunderwave", "Unseen Servant Ritual", "Witch Bolt"];
    var wi2 = ["Aganazzar's Scorcher", "Dust Devil", "Earthbind", "Maximilian's Earthen Grap", "Pyrotechnics", "Skywrite Ritual", "Snilloc's Snowball Swarm", "Alter Self", "Arcane Lock", "Blindness/Deafness", "Blur", "Cloud of Daggers", "Continual Flame", "Crown of Madness", "Darkness", "Darkvision", "Detect Thoughts", "Enlarge/Reduce", "Flaming Sphere", "Gentle Repose Ritual", "Gust of Wind", "Hold Person", "Invisibility", "Knock", "Levitate", "Locate Object", "Magic Mouth Ritual", "Magic Weapon", "Melf's Acid Arrow", "Mirror Image", "Misty Step", "Nystul's Magic Aura", "Phantasmal Force", "Ray of Enfeeblement", "Rope Trick", "Scorching Ray", "See Invisibility", "Shatter", "Spider Climb", "Suggestion", "Web"];
    var wi3 = ["Animate Dead", "Bestow Curse", "Blink", "Counterspell", "Counterspell", "Dispel Magic", "Fear", "Fireball", "Fireball", "Fireball", "Fly", "Gaseous Form", "Glyph of Warding", "Haste", "Haste", "Hypnotic Pattern", "Leomund’s Tiny Hut Ritual", "Lightning Bolt", "Magic Circle", "Major Image", "Protection from Energy", "Slow", "Stinking Cloud", "Vampiric Touch"]
    ...
    var wi5 = ["Control Winds", "Immolation", "Transmute Rock", "Animate Objects", "Bigby’s Hand", "CloudkilI", "Cone of Cold", "Conjure Elemental", "Contact Other Plane Ritual", "Creation", "Dominate Person", "Dream", "Geas", "Hold Monster", "Legend Lore", "Mislead", "Modify Memory", "Passwall", "Planar Binding", "Rary’s Telepathic Bond", "Scrying", "Seeming", "Telekinesis", "Teleportation Circle", "Wall of Force", "Wall of Stone"];
    var wi6 = ["Arcane Gate", "Chain Lightning", "Circle of Death", "Contingency", "Create Undead", "Disintegrate", "Drawmij’s Instant Summons", "Eyebite", "Flesh to Stone", "Globe of Invulnerability", "Guards and Wards", "Magic Jar", "Mass Suggestion", "Move Earth", "Otiluke’s Freezing Sphere", "Otto’s Irresistible Dance", "Programmed Illusion", "Sunbeam", "True Seeing", "Wall of Ice"];
    var wi7 = ["Delayed Blast Fireball", "Etherealness", "Finger of Death", "Forcecage", "Mirage Arcane", "Mordenkainen’s Magnificent Mansion", "Mordenkainen’s Sword", "Plane Shift", "Prismatic Spray", "Project Image", "Reverse Gravity", "Sequester", "Simulacrum", "Symbol", "Teleport"];
    var wi8 = ["Antimagic Field", "Antipathy/Sympathy", "Clone", "Control Weather", "Demiplane", "Dominate Monster", "Feeblemind", "Incendiary Cloud", "Maze", "Mind Blank", "Power Word Stun", "Sunburst", "Telepathy"];
    var wi9 = ["Astral Projection", "Foresight", "Gate", "Imprisonment", "Meteor Swarm", "Power Word Kill", "Prismatic Wall", "Shapechange", "Time Stop", "True Polymorph", "Weird", "Wish"];
    ...
    var scrollDruiUnc = ["Cure Wounds", "Conjure Animals", "Conjure Minor Elementals", "Hold Person", "Water Breathing Ritual"];
    ...
    var scrollPalaUnc = ["Cure Wounds", "Blinding Smite", "Dispel Magic", "Aura of Life", "Detect Magic Ritual", "Aid"];
    var scrollPalaRare = ["Raise Dead", "Geas", "Banishing Smite"];
    var scrollPalaVery = ["Raise Dead", "Geas", "Banishing Smite"];
    
    var scrollRangUnc = ["Cure Wounds", "Lightning Arrow", "Conjure Barrage", "Water Breathing Ritual"];
    var scrollRangRare = ["Conjure Volley", "Swift Quiver"];
    var scrollRangVery = ["Conjure Volley", "Swift Quiver"];
    
    var scrollWarlUnc = ["Vampiric Touch", "Tongues", "Gaseous Form", "Fear", "Spider Climb", "Comprehend Languages Ritual", "Shatter"];
    ...
    var scrollWizaUnc = ["Fireball", "Haste", "Slow", "Fly", "Knock", "Lightning Bolt", "Water Breathing Ritual", "Dispel Magic"];
    ...
    var ci1 = ["Mirror image", "Misty Step", "Water Breathing Ritual", "Water Walk Ritual"];
    var ci2 = ["Blur", "Silence Ritual", "Create Food and Water", "Protection from Energy"];
    var ci3 = ["Barkskin", "Spider Climb", "Call Lightning", "Plant Growth"];
    var ci4 = ["Invisibility", "Pass Without Trace", "Daylight", "Haste"];
    var ci5 = ["Spider Climb", "Spike Growth", "Lightning Bolt", "Meld into Stone Ritual"];
    var ci6 = ["Darkness", "Melf’s Acid Arrow", "Water Walk Ritual", "Stinking Cloud"];
    ...
    humanNameM = ["Wade", "Andrew", "Thomas", "Ander", "Blath", "Bran", "Frath", "Geth", "Lander", "Luth", "Malcer", "Stor", "Taman", "Urth", "Aseir", "Bardeid", "Haseid", "Khemed", "Mehmen", "Sudeiman", "Zasheir", "Bor", "Fodel", "Glar", "Grigor", "Igan", "Ivor", "Kosef", "Mival", "Orel", "Pavel", "Sergor", "Justin", "Frank"];
    humanNameF = ["Emily", "Amrye", "Amafrey", "Betha", "Cefrey", "Kethra", "Mara", "Olga", "Silifrey", "Westra", "Atala", "Ceidil", "Hama", "Jasmal", "Meilil", "Seipora", "Yasheira", "Zasheida", "Alethra", "Kara", "Katernin", "Mara", "Natali", "Olma", "Tana", "Zora"];
    humanNameLast = ["Brightwood", "Helder", "Hornraven", "Lackman", "Stormwind", "Windrivver", "Basha", "Dumein", "Jassan", "Khalid", "Mostana", "Pashar", "Rein", "Bersk", "Chernin", "Dotsk", "Kulenov", "Marsk", "Nemetsk", "Shemov", "Starag", "Case", "Stein"];
    ...
    function pickEldritch() {
        ...
        if (level > 11) {
            eldritch.push("Lifedrinker");
        
        }
        if (level > 14) {
            eldritch.push("Chains of Carceri");
            eldritch.push("Master of Myriad Forms");
            eldritch.push("Visions of Distant Realms");
            eldritch.push("Witch Sight");
        ...
        for (i = 0; i < y; ) {
            ...
            if ((level > 11) && (tempTxt.indexOf("Pact of the Blade") > -1) && (Math.random() > 0.67)) {
                x = "Lifedrinker";
            }
            if (((tempTxt.indexOf("Pact of the Chain")) > -1) && (Math.random() > 0.67)) {
                x = "Voice of the Chain Master";
            }
            if ((level > 14) && (tempTxt.indexOf("Pact of the Chain") > -1) && (Math.random() > 0.67)) {
                x = "Chains of Carceri";
            }
    ...
    // put a plus sign on a positive number
    function showPlus(x) {
        if (x > -1)
            return "+" + x;
        else
	...
	*/
    ...
    while (x > 0) 
    {
        ...
        tempFeats = tempAr[Math.floor(Math.random() * tempAr.length)];
        
        // check if we already know spell
        if (myFeats.indexOf(tempFeats) == -1) 
        {
            // add feat
            myFeats.push(tempFeats);
            x--;
        }
    }
        ...
        if (level > 1) {
            ...
            if ((x < 0.5) || (xx > 0)) {
                ...
                if (x == 0) {
                    ...
                    if (level > 8) {
                        ciSpells.push("Commune with Nature Ritual");
                ...
                if (x == 1) {
                    ...
                    if (level > 4) {
                        ciSpells.push("Water Breathing Ritual");
                        ciSpells.push("Water Walk Ritual");
                    }
                    if (level > 6) {
                ...
                if (x == 3) {
                    ...
                    if (level > 6) {
                        ciSpells.push("Divination Ritual");
                        ciSpells.push("Freedom of Movement");
                    }
                    if (level > 8) {
                        ciSpells.push("Commune with Nature Ritual");
                ...
                if (x == 5) {
                    ...
                    if (level > 4) {
                        ...
                        ciSpells.push("Meld into Stone Ritual");
                    }
                    if (level > 6) {
    ...
    case 9:
        ...
        if (level > 2) {
            ...
            case 0:
                ...
                if (level > 13) {
                    oaSpells.push("Freedom of Movement");
                    oaSpells.push("Guardian of Faith");
                }
                if (level > 16) {
                    oaSpells.push("Commune");
                    oaSpells.push("Flame Strike");
                }
            ...
            case 1:
                ...
                if (level > 13) {
                    oaSpells.push("Ice Storm");
                    oaSpells.push("Stoneskin");
                }
                if (level > 16) {
                    oaSpells.push("Commune with Nature");
                    oaSpells.push("Tree Stride");
                }
            ...
            case 2:
                ...
                if (level > 13) {
                    oaSpells.push("Banishment");
                    oaSpells.push("Dimension Door");
                }
                if (level > 16) {
                    oaSpells.push("Hold Monster");
                    oaSpells.push("Scrying");
                }
    ...
    case 14:
        ...
        if (level > 2) {
            ...
            case 0:
                ...
                mySpells.push("Find Familiar Ritual");
                break;
            case 1:
                classtxt += ", Blade Pact";
                tempTxt += "Blade)";
        ...
        if (level > 1) {
            ...
            if (tempAr.indexOf("Eldritch Sight") > -1) {
                waSpells.push("Detect Magic Ritual");
            }
            ...
            if (tempAr.indexOf("Chains of Carceri") > -1) {
                waSpells.push("Hold Monster (ounce per long rest)")
            }
            
            if (tempAr.indexOf("Master of Myriad Forms") > -1) {
                waSpells.push("Alter Self")
            }
            
            if (tempAr.indexOf("Visions of Distant Realms") > -1) {
                waSpells.push("Arcane Eye")
            }
            
            if (tempAr.indexOf("Witch Sight") > -1) {
                waSpells.push("Witch Sight (You can see the true form of any shapechanger or creature concealed by illusion or transmutation magic while the creature is within 30 feet of you and within line of sight.) ")
            }
    ...
    case 15:
        ...
        if (level > 1) {
            var schools = ["Abjuration", "Conjuration", "Divination Ritual", "Enchantment", "Evocation", "Illusion", "Necromancy", "Transmutation"]
            ...
            case 1:
                ...
                break;
            case 2:
                abOutput += ", Divination Ritual Savant, Portent";
                if (level > 5) {
                    abOutput += ", Expert Divination Ritual";
                }
                if (level > 9) {
...
*/
    ...
    case (6):
        ...
        if (x == 5)
            bgOutput += "(I needed to Commune with Nature Ritual, far from civilization.)";
        if (x == 6)
	...
	*/
    ...
    if (cl == 14) {
        ...
        while (x > 0) {
            ...
            if (Math.random() < 0.66)
                tempAr = ["Blade Ward", "Chill Touch", "Eldritch Blast", "Minor Illusion", "Poison Spray", "True Strike"];
    ...
    if (myCantrips.length > 0) {
       ...
       // if (mySpells.length > 0) {
         //   cOutput += " &nbsp; &nbsp; (<b>Spell save DC:</b>  " + (8 + prof + mod[spellAbility]) + ") ";
        //}
    
    
    }
    
    //var hFeat = feats[Math.floor(Math.random() * feats.length)];
    
    //if ((racetxt=="Human") && (level>0))
    //	spOutput += "<b>Human Feat:</b>  " + hFeat + ". <br>";
...
*/
    /*
for (x=0;x < myFeats.length;x++) 
{
	var fLink = myFeats[x].replace(/ /g, "-");
	fLink = fLink.replace(/\//g, "");
	fLink = fLink.replace(/'/g, "");
	if (x !==0) 
	
	{
		...
		spOutput += '<span onclick="spell_dialog_open(\'' + fLink + '\')">' + myFeats[x] + '</span>';
...
for (x=0;x < mySpells.length;x++) 
{
	...
	
	{
		...
		spOutput += '<span onclick="spell_dialog_open(\'' + link + '\')">' + mySpells[x] +'</span>';
	
}
*/
    if (level > 11)
        spOutput += "<b>Feats:</b>  " + myFeats + ". <br>";
    
    
    
    //1ST LVL SPELLS
    for (x = 0; x < mySpells0.length; x++) 
    {
        var nLink = mySpells0[x].replace(/ /g, "-");
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput1 += '<span onclick="spell_dialog_open(\'' + nLink + '\')">' + mySpells0[x] + '</span>';
    
    }
    //2ND LVL SPELLS
    for (x = 0; x < mySpells1.length; x++) 
    {
        var xLink = mySpells1[x].replace(/ /g, "-");
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput2 += '<span onclick="spell_dialog_open(\'' + xLink + '\')">' + mySpells1[x] + '</span>';
    
    }
    
    //3RD LVL SPELLS
    for (x = 0; x < mySpells2.length; x++) 
    {
        var yLink = mySpells2[x].replace(/ /g, "-");
        yLink = yLink.replace(/\//g, "");
        yLink = yLink.replace(/'/g, "");
        if (x !== 0) 
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput3 += '<span onclick="spell_dialog_open(\'' + yLink + '\')">' + mySpells2[x] + '</span>';
    
    }
    
    //4TH LVL SPELLS
    for (x = 0; x < mySpells3.length; x++) 
    {
        var zLink = mySpells3[x].replace(/ /g, "-");
        zLink = zLink.replace(/\//g, "");
        zLink = zLink.replace(/'/g, "");
        if (x !== 0) 
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput4 += '<span onclick="spell_dialog_open(\'' + zLink + '\')">' + mySpells3[x] + '</span>';
    
    }
    
    //5TH LVL SPELLS
    for (x = 0; x < mySpells4.length; x++) 
    {
        var xxLink = mySpells4[x].replace(/ /g, "-");
        xxLink = xxLink.replace(/\//g, "");
        xxLink = xxLink.replace(/'/g, "");
        if (x !== 0) 
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput5 += '<span onclick="spell_dialog_open(\'' + xxLink + '\')">' + mySpells4[x] + '</span>';
    
    }
    
    //6TH LVL SPELLS
    for (x = 0; x < mySpells5.length; x++) 
    {
        var yyLink = mySpells5[x].replace(/ /g, "-");
        yyLink = yyLink.replace(/\//g, "");
        yyLink = yyLink.replace(/'/g, "");
        if (x !== 0) 
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput6 += '<span onclick="spell_dialog_open(\'' + yyLink + '\')">' + mySpells5[x] + '</span>';
    
    }
    
    //7TH LVL SPELLS
    for (x = 0; x < mySpells6.length; x++) 
    {
        var zzLink = mySpells6[x].replace(/ /g, "-");
        zzLink = zzLink.replace(/\//g, "");
        zzLink = zzLink.replace(/'/g, "");
        if (x !== 0) 
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput7 += '<span onclick="spell_dialog_open(\'' + zzLink + '\')">' + mySpells6[x] + '</span>';
    
    }
    
    //8TH LVL SPELLS
    for (x = 0; x < mySpells7.length; x++) 
    {
        var yyyLink = mySpells7[x].replace(/ /g, "-");
        yyyLink = yyyLink.replace(/\//g, "");
        yyyLink = yyyLink.replace(/'/g, "");
        if (x !== 0) 
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput8 += '<span onclick="spell_dialog_open(\'' + yyyLink + '\')">' + mySpells7[x] + '</span>';
    
    }
    
    //9TH LVL SPELLS
    for (x = 0; x < mySpells8.length; x++) 
    {
        var zzzLink = mySpells8[x].replace(/ /g, "-");
        zzzLink = zzzLink.replace(/\//g, "");
        zzzLink = zzzLink.replace(/'/g, "");
        if (x !== 0) 
        ...
        //<a href="https://www.dnd-spells.com/spell/' + link + '">'
        spOutput9 += '<span onclick="spell_dialog_open(\'' + zzzLink + '\')">' + mySpells8[x] + '</span>';
    
    }
    
    
    //Bard Magical Secret Spells
    if (loSpells.length > 0) {
        spOutput += "<br><b>Bard Magical Secret Spells:</b> ";
        
        for (x = 0; x < loSpells.length; x++) 
        {
            var msLink = loSpells[x].replace(/ /g, "-");
            msLink = msLink.replace(/\//g, "");
            msLink = msLink.replace(/'/g, "");
            if (x !== 0) 
            {
                spOutput += ', '
            }
            spOutput += '<span onclick="spell_dialog_open(\'' + msLink + '\')">' + loSpells[x] + '</span>';
        }
    }
    ...
    {
        var cLink = myCantrips[x].replace(/ /g, "-");
        ...
        cOutput += '<span onclick="spell_dialog_open(\'' + cLink + '\')">' + myCantrips[x] + '</span>';
    }
    ...
    if (doSpells.length > 0) 
    {
        ...
        {
            var dLink = doSpells[x].replace(/ /g, "-");
            ...
            spOutput += '<span onclick="spell_dialog_open(\'' + dLink + '\')">' + doSpells[x] + '</span>';
        }
    }
    ...
    if (ciSpells.length > 0) {
        ...
        {
            var dcLink = ciSpells[x].replace(/ /g, "-");
            dcLink = dcLink.replace(/\//g, "");
            dcLink = dcLink.replace(/'/g, "");
            if (x !== 0) 
            {
                spOutput += ', '
            }
            spOutput += '<span onclick="spell_dialog_open(\'' + dcLink + '\')">' + ciSpells[x] + '</span>';
        }
    }
    ...
    if (oaSpells.length > 0) {
        ...
        {
            var poLink = oaSpells[x].replace(/ /g, "-");
            poLink = poLink.replace(/\//g, "");
            poLink = poLink.replace(/'/g, "");
            if (x !== 0) 
            {
                spOutput += ', '
            }
            spOutput += '<span onclick="spell_dialog_open(\'' + poLink + '\')">' + oaSpells[x] + '</span>';
        }
    }
    ...
    if (waTome.length > 0) 
    {
        ...
        {
            var wtLink = waTome[x].replace(/ /g, "-");
            wtLink = wtLink.replace(/\//g, "");
            wtLink = wtLink.replace(/'/g, "");
            if (x !== 0) 
            {
                spOutput += ', '
            }
            spOutput += '<span onclick="spell_dialog_open(\'' + wtLink + '\')">' + waTome[x] + '</span>';
        }
    }
    ...
    
    {
        ...
        {
            var trLink = waTomeRituals[x].replace(/ /g, "-");
            trLink = trLink.replace(/\//g, "");
            trLink = trLink.replace(/'/g, "");
            if (x !== 0) 
            {
                spOutput += ', '
            }
            spOutput += '<span onclick="spell_dialog_open(\'' + trLink + '\')">' + waTomeRituals[x] + '</span>';
        }
    }
...
*/
	...
	if (ss6 > 0) 
		spOutput += ", " + ss6+ " sixth level";
	if (ss7 > 0) 
		spOutput += ", " + ss7+ " seventh level";
	if (ss8 > 0) 
		spOutput += ", " + ss8+ " eighth level";
	if (ss9 > 0) 
		spOutput += ", " + ss9+ " ninth level";

	//<input id="qty" value="0" style="width: 20px;" />
	...
	if (cl==20) {
		...
		if (level > 8) {
			...
			spOutput += " sixth level";
		} else if (level > 12) {
			spOutput += " seventh level";
		} else if (level > 14) {
			spOutput += " eighth level";
		} else if (level > 16) {
			spOutput += " ninth level";
		}
		
	}
*/
        if (mySpells0.length > 0) 
        {
        spOutput += "<b>Spell save DC:  </b>" + (8 + prof + mod[spellAbility]) + "  &nbsp; &nbsp; <b>Spell Attack Modifier:<b>  " + showPlus(prof + mod[spellAbility]);
        }
    ...
    if (raceSpells.length > 0) {
        ...
        {
            var rmLink = raceSpells[x].replace(/ /g, "-");
            rmLink = rmLink.replace(/\//g, "");
            rmLink = rmLink.replace(/'/g, "");
            if (x !== 0) 
            ...
            //<a href="https://www.dnd-spells.com/spell/' + link + '">'
            spOutput += '<span onclick="spell_dialog_open(\'' + rmLink + '\')">' + raceSpells[x] + '</span>';
...
*/
        ...
        spOutput += " <br> Spell save DC:  " + (8 + prof + mod[raceSpellAbility]) + " &nbsp; &nbsp;  Spell Attack Modifier:  " + showPlus(prof + mod[raceSpellAbility]);
    ...
    if (level > 1) {
        ...
        if (upgrade() == true) {
            ...
            //1st item
            //2nd level = 38%, 3rd level = 57%, 5th level = 95%, 
            xx = (level * 20) / 100;
    ...
    if ((familiar.length == 0) && ((mySpells.indexOf("Find Familiar Ritual") > -1) || (waTomeRituals.indexOf("Find Familiar Ritual") > -1))) {
	...
	*/
    ...
    {
        document.getElementById("spellspot").style.display = "block"; //change to .style.display = "none" if useing the else part
    } 
   /* else 
    {
    ...
    */
    ...
    document.getElementById("spell1").innerHTML = spOutput1;
    document.getElementById("spell2").innerHTML = spOutput2;
    document.getElementById("spell3").innerHTML = spOutput3;
    document.getElementById("spell4").innerHTML = spOutput4;
    document.getElementById("spell5").innerHTML = spOutput5;
    document.getElementById("spell6").innerHTML = spOutput6;
    document.getElementById("spell7").innerHTML = spOutput7;
    document.getElementById("spell8").innerHTML = spOutput8;
    document.getElementById("spell9").innerHTML = spOutput9;
}


function toggleTable() 
{
    var lTable = document.getElementById("spellSlotsTable");
    lTable.style.display = (lTable.style.display == "table") ? "none" : "table";
}

function toggleCategory() 
{
    var Category = document.getElementById("categoryLinks");
    Category.style.display = (Category.style.display == "table") ? "none" : "table";
}

function toggleCategoryD20srd() 
{
    var categoryD20srd = document.getElementById("categoryD20srdLinks");
    categoryD20srd.style.display = (categoryD20srd.style.display == "table") ? "none" : "table";
}

function toggleCategoryDmsGuild() 
{
    var CategoryDmsGuild = document.getElementById("categoryDmsGuildLinks");
    CategoryDmsGuild.style.display = (CategoryDmsGuild.style.display == "table") ? "none" : "table";
}
/*
function togglePathfinderLinks() 
{
    var pathfinderLinks = document.getElementById("pathfinder");
    pathfinderLinks.style.display = (pathfinderLinks.style.display == "td") ? "none" : "table";
}
function togglefourthEditionLinks() 
{
    var fourthEditionLinks = document.getElementById("fourthEdition");
    fourthEditionLinks.style.display = (fourthEditionLinks.style.display == "td") ? "none" : "table";
}
function togglefifthEditionLinks() 
{
    var fifthEditionLinks = document.getElementById("fifthEdition");
    fifthEditionLinks.style.display = (fifthEditionLinks.style.display == "td") ? "none" : "table";
}
*/
/*
function toggleTablePictures() 
{
    var lTable = document.getElementById("rotatePictures");
    lTable.style.display = (lTable.style.display == "table") ? "none" : "table";
}
*/
